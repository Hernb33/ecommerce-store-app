export const products = [
  ...
  },
  {
    ...
    description:
      "Advanced smart watch featuring heart rate monitoring, GPS, and water resistance.",
    category: "Electronics",
    rating: 4.6,
    reviews: 187,
    inStock: true,
  ...
  },
  {
    ...
    description:
      "Professional grade camera with superior optics.",
  ...
  },
  {
    ...
    description:
      "Modern minimalist desk lamp with adjustable brightness.",
  ...
  },
  {
    ...
    description:
      "Organic cotton t-shirt with premium fabric.",
    category: "Fashion",
    rating: 5.0,
    reviews: 96,
    inStock: true,
  ...
  },
  {
    ...
    description:
      "Portable Bluetooth speaker with rich bass and crystal clear audio quality.",
    category: "Electronics",
    rating: 4.4,
    reviews: 574,
    inStock: true,
  ...
  },
  {
    ...
    description:
      "Running shoes with advanced cushioning and breathable design for optimal comfort.",
    category: "Sports",
    rating: 4.6,
    reviews: 312,
    inStock: true,
